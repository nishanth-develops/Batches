    ...
    <div className="min-h-screen font-sans">
      <main className="w-full bg-white shadow">
          ...
          <h1 className="text-[72px] font-bold text-center gradient-text mb-2">
            <span className="text-gray-900 heading">WELCOME TO </span>
            <span className="text-indigo-500 heading">BATCHES</span>
          </h1>
          <section className="bg-gradient-to-b from-[#d9d7f1] to-[#f7f7f7] min-h-screen flex items-center px-24">
  <div className="flex w-full px-8">
    <div className="w-3/5">
      <h1 className="text-7xl font-bold mb-2 px-12 leading-tight font">
        Celebrate Your Journey, Connect with Your Peers
      </h1>
    </div>
    <div className="w-2/5 px-6">
      <p className="text-lg mb-4 font">
      ...
      <div className="flex space-x-4">
        ...
        <section className="py-16 px-8 card">
          <h2 className="text-6xl font-bold text-center mb-16 heading">DISCOVER YOUR SENIORS</h2>
          
          <div className="flex justify-between gap-6 card">
            <div className="w-1/3">
              <div className="h-48 bg-amber-50 rounded-lg mb-4 card bg-[url('src/assets/batches.jpg')] bg-cover bg-center "></div>
              <h3 className="text-xl  mb-2 font">Find Alumni by Year, Branch, and Section with Ease</h3>
              <button className="bg-black text-white px-6 py-2 mt-4">Start Now</button>
            </div>
            
            <div className="w-1/3">
              <div className="h-48 bg-amber-50 rounded-lg mb-4 card bg-[url('src/assets/acheivements.jpg')] bg-cover bg-center"></div>
              <h3 className="text-xl mb-2 font">Navigate Through Categories to Discover Your Peers' Achievements</h3>
              <button className="bg-black text-white px-6 py-2 mt-4">Start Now</button>
            </div>
            
            <div className="w-1/3">
              <div className="h-48 bg-amber-50 rounded-lg mb-4 card bg-[url('src/assets/companies.jpg')] bg-cover bg-center"></div>
              <h3 className="text-xl mb-2 font">Gain deeper insights into the companies where our alumni are making an impact</h3>
              <button className="bg-black text-white px-6 py-2 mt-4">Start Now</button>
            </div>
          </div>
        </section>
